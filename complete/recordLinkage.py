...
datasetA_name = 'datasets/dataset-A.csv'
datasetB_name = 'datasets/dataset-B.csv'
...
#truthfile_name = 'datasets/true-matches.csv'
...
# attribute lists)
#
blocking_attrA_list = [4,7,10]
blocking_attrB_list = [4,7,10]
...
#
weight_vec = [2.0, 2.0, 3.0, 2.0, 2.0, 1.0]
...
#saveLinkResult.save_linkage_set('Result.csv', class_match_set)
